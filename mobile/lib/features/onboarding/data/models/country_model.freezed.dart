...
abstract class $CountryModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, String code, String name, String currency});
}
...
class _$CountryModelImpl implements _CountryModel {
  ...
  @override
  String toString() {
    return 'CountryModel(id: $id, code: $code, name: $name, currency: $currency)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, id, code, name, currency);
