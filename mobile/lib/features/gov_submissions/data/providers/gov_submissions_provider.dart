...
final govSubmissionsProvider = FutureProvider.autoDispose<List<GovSubmission>>((
  ref,
) async {
  final response = await ApiService().gov.getSubmissions();
  final List<dynamic> data = response.data as List<dynamic>;
  return data
      .map((json) => GovSubmission.fromJson(json as Map<String, dynamic>))
      .toList();
});

/// Provider to generate a PAYE supporting worksheet.
final generateKraP10Provider = FutureProvider.autoDispose
    .family<GovSubmission, String>((ref, payPeriodId) async {
...
final generateShifProvider = FutureProvider.autoDispose
    .family<GovSubmission, String>((ref, payPeriodId) async {
...
final generateNssfProvider = FutureProvider.autoDispose
    .family<GovSubmission, String>((ref, payPeriodId) async {
