...
_WorkerModel _$WorkerModelFromJson(Map<String, dynamic> json) => _WorkerModel(
  ...
  nonTaxableAllowance: (json['nonTaxableAllowance'] as num?)?.toDouble() ?? 0.0,
  hasDisabilityExemption: json['hasDisabilityExemption'] as bool? ?? false,
...
Map<String, dynamic> _$WorkerModelToJson(_WorkerModel instance) =>
    <String, dynamic>{
      ...
      'hasDisabilityExemption': instance.hasDisabilityExemption,
...
_CreateWorkerRequest _$CreateWorkerRequestFromJson(Map<String, dynamic> json) =>
    _CreateWorkerRequest(
      ...
      hasDisabilityExemption: json['hasDisabilityExemption'] as bool?,
