...
mixin _$WorkerModel {
 ...
 String get id; String get name; String get phoneNumber; double get salaryGross; DateTime? get startDate; DateTime? get dateOfBirth; bool get isActive; String get employmentType; double? get hourlyRate; String? get propertyId; String? get photoUrl; String? get email; String? get idNumber; String? get kraPin; String? get nssfNumber; String? get nhifNumber; String? get jobTitle; double get housingAllowance; double get transportAllowance; double get pensionContribution; double get mortgageInterest; double get hospContribution; double get postRetirementMedicalContribution; double get lifeInsurancePremium; double get nonCashBenefits; double get nonTaxableAllowance; bool get hasDisabilityExemption; String get paymentFrequency; String get paymentMethod; String? get mpesaNumber; String? get bankName; String? get bankCode; String? get bankAccount; String? get notes; String? get emergencyContactName; String? get emergencyContactPhone; String? get emergencyContactRelationship; DateTime? get terminatedAt; DateTime? get createdAt; DateTime? get updatedAt;
...
as double,pensionContribution: null == pensionContribution ? _self.pensionContribution : pensionContribution // ignore: cast_nullable_to_non_nullable
as double,mortgageInterest: null == mortgageInterest ? _self.mortgageInterest : mortgageInterest // ignore: cast_nullable_to_non_nullable
as double,hospContribution: null == hospContribution ? _self.hospContribution : hospContribution // ignore: cast_nullable_to_non_nullable
as double,postRetirementMedicalContribution: null == postRetirementMedicalContribution ? _self.postRetirementMedicalContribution : postRetirementMedicalContribution // ignore: cast_nullable_to_non_nullable
as double,lifeInsurancePremium: null == lifeInsurancePremium ? _self.lifeInsurancePremium : lifeInsurancePremium // ignore: cast_nullable_to_non_nullable
as double,nonCashBenefits: null == nonCashBenefits ? _self.nonCashBenefits : nonCashBenefits // ignore: cast_nullable_to_non_nullable
as double,nonTaxableAllowance: null == nonTaxableAllowance ? _self.nonTaxableAllowance : nonTaxableAllowance // ignore: cast_nullable_to_non_nullable
as double,hasDisabilityExemption: null == hasDisabilityExemption ? _self.hasDisabilityExemption : hasDisabilityExemption // ignore: cast_nullable_to_non_nullable
as bool,paymentFrequency: null == paymentFrequency ? _self.paymentFrequency : paymentFrequency // ignore: cast_nullable_to_non_nullable
...
switch (_that) {
case _WorkerModel() when $default != null:
return $default(_that.id,_that.name,_that.phoneNumber,_that.salaryGross,_that.startDate,_that.dateOfBirth,_that.isActive,_that.employmentType,_that.hourlyRate,_that.propertyId,_that.photoUrl,_that.email,_that.idNumber,_that.kraPin,_that.nssfNumber,_that.nhifNumber,_that.jobTitle,_that.housingAllowance,_that.transportAllowance,_that.pensionContribution,_that.mortgageInterest,_that.hospContribution,_that.postRetirementMedicalContribution,_that.lifeInsurancePremium,_that.nonCashBenefits,_that.nonTaxableAllowance,_that.hasDisabilityExemption,_that.paymentFrequency,_that.paymentMethod,_that.mpesaNumber,_that.bankName,_that.bankCode,_that.bankAccount,_that.notes,_that.emergencyContactName,_that.emergencyContactPhone,_that.emergencyContactRelationship,_that.terminatedAt,_that.createdAt,_that.updatedAt);case _:
  return orElse();
...
class _WorkerModel implements WorkerModel {
  const _WorkerModel({required this.id, required this.name, required this.phoneNumber, required this.salaryGross, this.startDate, this.dateOfBirth, required this.isActive, this.employmentType = 'FIXED', this.hourlyRate, this.propertyId, this.photoUrl, this.email, this.idNumber, this.kraPin, this.nssfNumber, this.nhifNumber, this.jobTitle, this.housingAllowance = 0.0, this.transportAllowance = 0.0, this.pensionContribution = 0.0, this.mortgageInterest = 0.0, this.hospContribution = 0.0, this.postRetirementMedicalContribution = 0.0, this.lifeInsurancePremium = 0.0, this.nonCashBenefits = 0.0, this.nonTaxableAllowance = 0.0, this.hasDisabilityExemption = false, this.paymentFrequency = 'MONTHLY', this.paymentMethod = 'MPESA', this.mpesaNumber, this.bankName, this.bankCode, this.bankAccount, this.notes, this.emergencyContactName, this.emergencyContactPhone, this.emergencyContactRelationship, this.terminatedAt, this.createdAt, this.updatedAt});
...
@override@JsonKey() final  double pensionContribution;
@override@JsonKey() final  double mortgageInterest;
@override@JsonKey() final  double hospContribution;
@override@JsonKey() final  double postRetirementMedicalContribution;
@override@JsonKey() final  double lifeInsurancePremium;
@override@JsonKey() final  double nonCashBenefits;
@override@JsonKey() final  double nonTaxableAllowance;
@override@JsonKey() final  bool hasDisabilityExemption;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,name,phoneNumber,salaryGross,startDate,dateOfBirth,employmentType,hourlyRate,propertyId,photoUrl,email,idNumber,kraPin,nssfNumber,nhifNumber,jobTitle,housingAllowance,transportAllowance,pensionContribution,mortgageInterest,hospContribution,postRetirementMedicalContribution,lifeInsurancePremium,nonCashBenefits,nonTaxableAllowance,hasDisabilityExemption,paymentFrequency,paymentMethod,mpesaNumber,bankName,bankCode,bankAccount,notes,emergencyContactName,emergencyContactPhone,emergencyContactRelationship]);
...
/// Create a copy of CreateWorkerRequest
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? name = null,Object? phoneNumber = null,Object? salaryGross = null,Object? startDate = freezed,Object? dateOfBirth = freezed,Object? employmentType = null,Object? hourlyRate = freezed,Object? propertyId = freezed,Object? photoUrl = freezed,Object? email = freezed,Object? idNumber = freezed,Object? kraPin = freezed,Object? nssfNumber = freezed,Object? nhifNumber = freezed,Object? jobTitle = freezed,Object? housingAllowance = freezed,Object? transportAllowance = freezed,Object? pensionContribution = freezed,Object? mortgageInterest = freezed,Object? hospContribution = freezed,Object? postRetirementMedicalContribution = freezed,Object? lifeInsurancePremium = freezed,Object? nonCashBenefits = freezed,Object? nonTaxableAllowance = freezed,Object? hasDisabilityExemption = freezed,Object? paymentFrequency = freezed,Object? paymentMethod = freezed,Object? mpesaNumber = freezed,Object? bankName = freezed,Object? bankCode = freezed,Object? bankAccount = freezed,Object? notes = freezed,Object? emergencyContactName = freezed,Object? emergencyContactPhone = freezed,Object? emergencyContactRelationship = freezed,}) {
  return _then(_self.copyWith(
...
as double?,pensionContribution: freezed == pensionContribution ? _self.pensionContribution : pensionContribution // ignore: cast_nullable_to_non_nullable
as double?,mortgageInterest: freezed == mortgageInterest ? _self.mortgageInterest : mortgageInterest // ignore: cast_nullable_to_non_nullable
as double?,hospContribution: freezed == hospContribution ? _self.hospContribution : hospContribution // ignore: cast_nullable_to_non_nullable
as double?,postRetirementMedicalContribution: freezed == postRetirementMedicalContribution ? _self.postRetirementMedicalContribution : postRetirementMedicalContribution // ignore: cast_nullable_to_non_nullable
as double?,lifeInsurancePremium: freezed == lifeInsurancePremium ? _self.lifeInsurancePremium : lifeInsurancePremium // ignore: cast_nullable_to_non_nullable
as double?,nonCashBenefits: freezed == nonCashBenefits ? _self.nonCashBenefits : nonCashBenefits // ignore: cast_nullable_to_non_nullable
as double?,nonTaxableAllowance: freezed == nonTaxableAllowance ? _self.nonTaxableAllowance : nonTaxableAllowance // ignore: cast_nullable_to_non_nullable
as double?,hasDisabilityExemption: freezed == hasDisabilityExemption ? _self.hasDisabilityExemption : hasDisabilityExemption // ignore: cast_nullable_to_non_nullable
as bool?,paymentFrequency: freezed == paymentFrequency ? _self.paymentFrequency : paymentFrequency // ignore: cast_nullable_to_non_nullable
...
class _CreateWorkerRequest implements CreateWorkerRequest {
  const _CreateWorkerRequest({required this.name, required this.phoneNumber, required this.salaryGross, this.startDate, this.dateOfBirth, this.employmentType = 'FIXED', this.hourlyRate, this.propertyId, this.photoUrl, this.email, this.idNumber, this.kraPin, this.nssfNumber, this.nhifNumber, this.jobTitle, this.housingAllowance, this.transportAllowance, this.pensionContribution, this.mortgageInterest, this.hospContribution, this.postRetirementMedicalContribution, this.lifeInsurancePremium, this.nonCashBenefits, this.nonTaxableAllowance, this.hasDisabilityExemption, this.paymentFrequency, this.paymentMethod, this.mpesaNumber, this.bankName, this.bankCode, this.bankAccount, this.notes, this.emergencyContactName, this.emergencyContactPhone, this.emergencyContactRelationship});
...
@override final  double? pensionContribution;
@override final  double? mortgageInterest;
@override final  double? hospContribution;
@override final  double? postRetirementMedicalContribution;
@override final  double? lifeInsurancePremium;
@override final  double? nonCashBenefits;
@override final  double? nonTaxableAllowance;
@override final  bool? hasDisabilityExemption;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,name,phoneNumber,salaryGross,startDate,dateOfBirth,employmentType,hourlyRate,propertyId,photoUrl,isActive,email,idNumber,kraPin,nssfNumber,nhifNumber,jobTitle,housingAllowance,transportAllowance,pensionContribution,mortgageInterest,hospContribution,postRetirementMedicalContribution,lifeInsurancePremium,nonCashBenefits,nonTaxableAllowance,hasDisabilityExemption,paymentFrequency,paymentMethod,mpesaNumber,bankName,bankCode,bankAccount,notes,emergencyContactName,emergencyContactPhone,emergencyContactRelationship]);
...
switch (_that) {
case _UpdateWorkerRequest() when $default != null:
return $default(_that.name,_that.phoneNumber,_that.salaryGross,_that.startDate,_that.dateOfBirth,_that.employmentType,_that.hourlyRate,_that.propertyId,_that.photoUrl,_that.isActive,_that.email,_that.idNumber,_that.kraPin,_that.nssfNumber,_that.nhifNumber,_that.jobTitle,_that.housingAllowance,_that.transportAllowance,_that.pensionContribution,_that.mortgageInterest,_that.hospContribution,_that.postRetirementMedicalContribution,_that.lifeInsurancePremium,_that.nonCashBenefits,_that.nonTaxableAllowance,_that.hasDisabilityExemption,_that.paymentFrequency,_that.paymentMethod,_that.mpesaNumber,_that.bankName,_that.bankCode,_that.bankAccount,_that.notes,_that.emergencyContactName,_that.emergencyContactPhone,_that.emergencyContactRelationship);case _:
  return orElse();
...
class _UpdateWorkerRequest implements UpdateWorkerRequest {
  const _UpdateWorkerRequest({this.name, this.phoneNumber, this.salaryGross, this.startDate, this.dateOfBirth, this.employmentType, this.hourlyRate, this.propertyId, this.photoUrl, this.isActive, this.email, this.idNumber, this.kraPin, this.nssfNumber, this.nhifNumber, this.jobTitle, this.housingAllowance, this.transportAllowance, this.pensionContribution, this.mortgageInterest, this.hospContribution, this.postRetirementMedicalContribution, this.lifeInsurancePremium, this.nonCashBenefits, this.nonTaxableAllowance, this.hasDisabilityExemption, this.paymentFrequency, this.paymentMethod, this.mpesaNumber, this.bankName, this.bankCode, this.bankAccount, this.notes, this.emergencyContactName, this.emergencyContactPhone, this.emergencyContactRelationship});
