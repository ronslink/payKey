...
switch (_that) {
case _UpdateWorkerRequest() when $default != null:
return $default(_that.name,_that.phoneNumber,_that.salaryGross,_that.startDate,_that.dateOfBirth,_that.employmentType,_that.hourlyRate,_that.propertyId,_that.photoUrl,_that.isActive,_that.email,_that.idNumber,_that.kraPin,_that.nssfNumber,_that.nhifNumber,_that.jobTitle,_that.housingAllowance,_that.transportAllowance,_that.pensionContribution,_that.nonCashBenefits,_that.nonTaxableAllowance,_that.hasDisabilityExemption,_that.paymentFrequency,_that.paymentMethod,_that.mpesaNumber,_that.bankName,_that.bankCode,_that.bankAccount,_that.notes,_that.emergencyContactName,_that.emergencyContactPhone,_that.emergencyContactRelationship);case _:
  return orElse();
