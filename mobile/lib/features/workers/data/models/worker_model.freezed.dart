...
class _WorkerModel implements WorkerModel {
  const _WorkerModel({required this.id, required this.name, required this.phoneNumber, required this.salaryGross, this.startDate, this.dateOfBirth, required this.isActive, this.employmentType = 'FIXED', this.hourlyRate, this.propertyId, this.photoUrl, this.email, this.idNumber, this.kraPin, this.nssfNumber, this.nhifNumber, this.jobTitle, this.housingAllowance = 0.0, this.transportAllowance = 0.0, this.paymentFrequency = 'MONTHLY', this.paymentMethod = 'MPESA', this.mpesaNumber, this.bankName, this.bankAccount, this.notes, this.emergencyContactName, this.emergencyContactPhone, this.emergencyContactRelationship, this.terminatedAt, this.createdAt, this.updatedAt});
...
class _CreateWorkerRequest implements CreateWorkerRequest {
  const _CreateWorkerRequest({required this.name, required this.phoneNumber, required this.salaryGross, this.startDate, this.dateOfBirth, this.employmentType = 'FIXED', this.hourlyRate, this.propertyId, this.photoUrl, this.email, this.idNumber, this.kraPin, this.nssfNumber, this.nhifNumber, this.jobTitle, this.housingAllowance, this.transportAllowance, this.paymentFrequency, this.paymentMethod, this.mpesaNumber, this.bankName, this.bankAccount, this.notes, this.emergencyContactName, this.emergencyContactPhone, this.emergencyContactRelationship});
...
class _UpdateWorkerRequest implements UpdateWorkerRequest {
  const _UpdateWorkerRequest({this.name, this.phoneNumber, this.salaryGross, this.startDate, this.dateOfBirth, this.employmentType, this.hourlyRate, this.propertyId, this.photoUrl, this.isActive, this.email, this.idNumber, this.kraPin, this.nssfNumber, this.nhifNumber, this.jobTitle, this.housingAllowance, this.transportAllowance, this.paymentFrequency, this.paymentMethod, this.mpesaNumber, this.bankName, this.bankAccount, this.notes, this.emergencyContactName, this.emergencyContactPhone, this.emergencyContactRelationship});
