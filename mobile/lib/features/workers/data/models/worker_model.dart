...
abstract class WorkerModel with _$WorkerModel {
  const factory WorkerModel({
    ...
    @Default(0.0) double pensionContribution,
    @Default(0.0) double mortgageInterest,
    @Default(0.0) double hospContribution,
    @Default(0.0) double postRetirementMedicalContribution,
    @Default(0.0) double lifeInsurancePremium,
    @Default(0.0) double nonCashBenefits,
    @Default(0.0) double nonTaxableAllowance,
    @Default(false) bool hasDisabilityExemption,
...
abstract class CreateWorkerRequest with _$CreateWorkerRequest {
  const factory CreateWorkerRequest({
    ...
    double? hospContribution,
    double? postRetirementMedicalContribution,
    double? lifeInsurancePremium,
    double? nonCashBenefits,
