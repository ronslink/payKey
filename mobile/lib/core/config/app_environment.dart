...
class AppEnvironment {
  ...
  static const bool intasendIsLive = bool.fromEnvironment(
    'INTASEND_IS_LIVE',
    defaultValue: false,
  );

  /// IntaSend Publishable Key
  static const String intasendPubKey = String.fromEnvironment(
    'INTASEND_PUB_KEY',
    defaultValue: '',
  );

  /// IntaSend Secret Key
  static const String intasendSecretKey = String.fromEnvironment(
    'INTASEND_SECRET_KEY',
    defaultValue: '',
  );

  /// Direct Stripe/M-Pesa subscription checkout must stay disabled in App
  /// Store and Play Store release builds unless the distribution channel has
  /// explicitly approved it. Debug builds remain enabled for QA.
  static const bool externalSubscriptionCheckoutEnabled = bool.fromEnvironment(
    'ENABLE_EXTERNAL_SUBSCRIPTION_CHECKOUT',
    defaultValue: !kReleaseMode,
  );

  static bool get canUseExternalSubscriptionCheckout {
    if (kIsWeb) return true;
    if (!Platform.isIOS && !Platform.isAndroid) return true;
    return externalSubscriptionCheckoutEnabled;
  }
  ...
  static const String googleWebClientId = String.fromEnvironment(
    ...
    defaultValue:
        '126777889122-v87pps2i4i9m5m3p8r2infbvspjq62mg.apps.googleusercontent.com',
  );
  ...
  static const String googleIosClientId = String.fromEnvironment(
    'GOOGLE_CLIENT_ID',
    defaultValue:
        '104336380998-jenvsdcitnun7un5j00aqnoggnrefbaa.apps.googleusercontent.com',
  );
