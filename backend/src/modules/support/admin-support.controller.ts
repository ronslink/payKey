...
import { TicketStatus, TicketCategory, TicketPriority } from './entities/support-ticket.entity';
...
export class AdminSupportController {
    ...
    updateTicket(
        @Param('id') id: string,
        @Body() body: { status?: TicketStatus; priority?: TicketPriority; adminNotes?: string },
    ) {
