...
import { AccountingExport, ExportFormat } from './entities/accounting-export.entity';
...
export class AccountingExportService {
    ...
    async getAccountMappings(userId: string): Promise<Record<AccountCategory, { accountCode: string; accountName: string }>> {
    ...
    getDefaultAccountMappings(): Record<AccountCategory, { accountCode: string; accountName: string }> {
        return {
    ...
    async saveAccountMappings(
        userId: string,
        mappings: Array<{ category: AccountCategory; accountCode: string; accountName: string }>,
