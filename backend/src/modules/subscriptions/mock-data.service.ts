...
export class MockDataService {
    ...
    generateMultiPropertyData(): MockPropertyData {
        return {
            ...
            data: {
                ...
                propertyComparison: [
                    { property: 'Kilimani Residence', jan: 120000, feb: 122000, mar: 125000 },
                    { property: 'Westlands Office', jan: 275000, feb: 280000, mar: 285000 },
    ...
    generateAccountingData(): MockAccountingData {
        return {
            ...
            data: {
                ...
                connectedApps: [
                    { name: 'QuickBooks', status: 'connected', lastSync: this.pastDate(1) },
    ...
    generateAdvancedReports(): MockAdvancedReports {
        return {
            ...
            data: {
                ...
                customReports: [
                    { name: 'Monthly Payroll Summary', format: 'PDF', generated: this.pastDate(5) },
                    { name: 'Annual Tax Report', format: 'Excel', generated: this.pastDate(30) },
                    { name: 'Worker Cost Analysis', format: 'PDF', generated: this.pastDate(15) },
                ],
            },
        };
    }
    ...
    private randomLocation(): string {
        const locations = ['Main Entrance', 'Kitchen', 'Garden', 'Office', 'Garage'];
