        ...
        await queryRunner.createTable(
            new Table({
                ...
                columns: [
                    ...
                    { name: 'totalPaye', type: 'decimal', precision: 12, scale: 2, default: 0 },
                    { name: 'totalNssf', type: 'decimal', precision: 12, scale: 2, default: 0 },
                    { name: 'totalNhif', type: 'decimal', precision: 12, scale: 2, default: 0 },
                    { name: 'totalHousingLevy', type: 'decimal', precision: 12, scale: 2, default: 0 },
                    { name: 'status', type: 'enum', enum: ['PENDING', 'FILED'], default: "'PENDING'" },
