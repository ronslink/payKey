        ...
        await queryRunner.createTable(
            new Table({
                ...
                columns: [
                    ...
                    { name: 'discountPercentage', type: 'decimal', precision: 10, scale: 2, isNullable: true },
                    { name: 'discountAmount', type: 'decimal', precision: 10, scale: 2, isNullable: true },
            ...
            new Table({
                ...
                columns: [
                    ...
                    { name: 'description', type: 'text', isNullable: true },
                    {
                        name: 'type',
                        type: 'enum',
                        enum: ['BANNER', 'POPUP', 'EMAIL', 'IN_APP_NOTIFICATION', 'SIDEBAR'],
                    },
                    {
                        name: 'status',
                        type: 'enum',
