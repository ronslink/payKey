...
describe('Gov Integrations E2E', () => {
    ...
    it('should generate KRA P10 Excel file', async () => {
        const submission = await kraService.generateP10Excel(payPeriodId, testUser.id);
    ...
    it('should generate NSSF Excel file', async () => {
        const submission = await nssfService.generateNSSFExcel(payPeriodId, testUser.id);
        expect(submission).toBeDefined();
    ...
    it('should generate SHIF Excel file', async () => {
        const submission = await shifService.generateSHIFExcel(payPeriodId, testUser.id);
        expect(submission).toBeDefined();
