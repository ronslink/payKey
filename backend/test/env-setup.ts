...
process.env.DB_PASSWORD = process.env.DB_PASSWORD || 'Tina76';
...
process.env.JWT_SECRET =
  process.env.JWT_SECRET || 'test_secret_key_for_ci_cd_pipeline_12345';
...
console.log(
  `   DB: ${process.env.DB_USER}@${process.env.DB_HOST}:${process.env.DB_PORT}/${process.env.DB_NAME}`,
);
