...
export declare class PayrollService {
    ...
    constructor(workersRepository: Repository<Worker>, payrollRepository: Repository<PayrollRecord>, taxesService: TaxesService);
    ...
    finalizePayroll(userId: string, payPeriodId: string): Promise<PayrollRecord[]>;
}
