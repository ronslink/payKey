...
const tax_config_entity_1 = require("./src/modules/tax-config/entities/tax-config.entity");
(0, dotenv_1.config)();
async function seedTaxConfigs() {
    try {
        ...
        const connection = await (0, typeorm_1.createConnection)({
            ...
            entities: [tax_config_entity_1.TaxConfig],
            synchronize: false,
            logging: true,
        });
        console.log('Connected successfully!');
        const taxConfigRepository = connection.getRepository(tax_config_entity_1.TaxConfig);
...
seedTaxConfigs();
//# sourceMappingURL=seed-tax-configs.js.map