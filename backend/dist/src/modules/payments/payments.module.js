...
exports.PaymentsModule = PaymentsModule = __decorate([
    (0, common_1.Module)({
        imports: [
            typeorm_1.TypeOrmModule.forFeature([transaction_entity_1.Transaction, worker_entity_1.Worker, pay_period_entity_1.PayPeriod, payroll_record_entity_1.PayrollRecord, tax_submission_entity_1.TaxSubmission]),
            taxes_module_1.TaxesModule,
            time_tracking_module_1.TimeTrackingModule,
            axios_1.HttpModule,
        ],
        controllers: [payments_controller_1.PaymentsController],
        providers: [mpesa_service_1.MpesaService, payroll_payment_service_1.PayrollPaymentService],
        exports: [mpesa_service_1.MpesaService, payroll_payment_service_1.PayrollPaymentService],
    })
], PaymentsModule);
