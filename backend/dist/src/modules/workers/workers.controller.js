...
let WorkersController = class WorkersController {
    ...
    constructor(workersService, terminationService, leaveManagementService) {
    ...
    createLeaveRequest(req, workerId, createLeaveRequestDto) {
        return this.leaveManagementService.createLeaveRequest(req.user.userId, workerId, createLeaveRequestDto);
    }
    getLeaveRequests(req) {
        return this.leaveManagementService.getLeaveRequestsForUser(req.user.userId);
    }
    getWorkerLeaveRequests(req, workerId) {
        return this.leaveManagementService.getLeaveRequestsForWorker(req.user.userId, workerId);
    }
    approveLeaveRequest(req, requestId, approveLeaveRequestDto) {
        return this.leaveManagementService.approveLeaveRequest(req.user.userId, requestId, approveLeaveRequestDto);
    }
    updateLeaveRequest(req, requestId, updateLeaveRequestDto) {
        return this.leaveManagementService.updateLeaveRequest(req.user.userId, requestId, updateLeaveRequestDto);
    }
    cancelLeaveRequest(req, requestId) {
        return this.leaveManagementService.cancelLeaveRequest(req.user.userId, requestId);
    }
    getLeaveBalance(req, workerId) {
...
__decorate([
    ...
    __param(2, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, String, create_leave_request_dto_1.CreateLeaveRequestDto]),
    __metadata("design:returntype", void 0)
], WorkersController.prototype, "createLeaveRequest", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
], WorkersController.prototype, "getLeaveRequests", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Object, String]),
    __metadata("design:returntype", void 0)
], WorkersController.prototype, "getWorkerLeaveRequests", null);
__decorate([
    (0, common_1.Patch)('leave-requests/:requestId/approve'),
    (0, common_1.UseGuards)(subscription_guard_1.SubscriptionGuard),
    __param(0, (0, common_1.Request)()),
    __param(1, (0, common_1.Param)('requestId')),
    __param(2, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, String, create_leave_request_dto_1.ApproveLeaveRequestDto]),
    __metadata("design:returntype", void 0)
], WorkersController.prototype, "approveLeaveRequest", null);
__decorate([
    (0, common_1.Patch)('leave-requests/:requestId'),
    (0, common_1.UseGuards)(subscription_guard_1.SubscriptionGuard),
    __param(0, (0, common_1.Request)()),
    __param(1, (0, common_1.Param)('requestId')),
    __param(2, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, String, create_leave_request_dto_1.UpdateLeaveRequestDto]),
    __metadata("design:returntype", void 0)
], WorkersController.prototype, "updateLeaveRequest", null);
__decorate([
    (0, common_1.Delete)('leave-requests/:requestId'),
    (0, common_1.UseGuards)(subscription_guard_1.SubscriptionGuard),
    __param(0, (0, common_1.Request)()),
    __param(1, (0, common_1.Param)('requestId')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, String]),
    __metadata("design:returntype", void 0)
], WorkersController.prototype, "cancelLeaveRequest", null);
__decorate([
    (0, common_1.Get)(':id/leave-balance'),
    (0, common_1.UseGuards)(subscription_guard_1.SubscriptionGuard),
    __param(0, (0, common_1.Request)()),
    __param(1, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, String]),
    __metadata("design:returntype", void 0)
], WorkersController.prototype, "getLeaveBalance", null);
exports.WorkersController = WorkersController = __decorate([
    ...
    __metadata("design:paramtypes", [workers_service_1.WorkersService,
        ...
        leave_management_service_1.LeaveManagementService])
], WorkersController);
