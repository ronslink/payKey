...
let TaxesController = class TaxesController {
    ...
    generateTaxSubmission(req, payPeriodId) {
        return this.taxesService.generateTaxSubmission(payPeriodId, req.user.userId);
    }
    getTaxSubmissionByPeriod(req, payPeriodId) {
...
__decorate([
    (0, common_1.Post)('submissions/generate/:payPeriodId'),
    __param(0, (0, common_1.Request)()),
    __param(1, (0, common_1.Param)('payPeriodId')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, String]),
    __metadata("design:returntype", void 0)
], TaxesController.prototype, "generateTaxSubmission", null);
__decorate([
    (0, common_1.Get)('submissions/period/:payPeriodId'),
    __param(0, (0, common_1.Request)()),
    __param(1, (0, common_1.Param)('payPeriodId')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, String]),
    __metadata("design:returntype", void 0)
], TaxesController.prototype, "getTaxSubmissionByPeriod", null);
__decorate([
