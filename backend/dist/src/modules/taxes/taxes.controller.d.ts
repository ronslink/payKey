...
export declare class TaxesController {
    ...
    generateTaxSubmission(req: any, payPeriodId: string): Promise<import("./entities/tax-submission.entity").TaxSubmission>;
    getTaxSubmissionByPeriod(req: any, payPeriodId: string): Promise<import("./entities/tax-submission.entity").TaxSubmission | null>;
